...
hi Folded           cterm=none      ctermfg=15      ctermbg=5
...
hi StatusLine       cterm=bold      ctermfg=15      ctermbg=5
hi StatusLineNC     cterm=bold      ctermfg=15      ctermbg=5
hi TabLine          cterm=none      ctermfg=15      ctermbg=5
hi TabLineFill      cterm=none      ctermfg=5       ctermbg=5
hi TabLineSel       cterm=bold      ctermfg=15      ctermbg=235
