...
if !has('gui_running')
  if exists('g:tinted_shell_path')
    execute 'silent !/bin/sh '.g:tinted_shell_path.'/base24/human-plus-plus.sh'
  endif
endif
...
let s:gui0E        = '9871fe'
let s:gui0F        = 'bbff00'
let s:gui10        = 'c8518f{{^base10-hex}}1a1c22{{/base10-hex}}'
let s:gui11        = 'd68c6f{{^base11-hex}}1a1c22{{/base11-hex}}'
let s:gui12        = 'dfb683{{^base12-hex}}e7349c{{/base12-hex}}'
let s:gui13        = '61b186{{^base13-hex}}f2a633{{/base13-hex}}'
let s:gui14        = '91cbcd{{^base14-hex}}04b372{{/base14-hex}}'
let s:gui15        = '5e84b6{{^base15-hex}}1ad0d6{{/base15-hex}}'
let s:gui16        = '8f72e3{{^base16-hex}}458ae2{{/base16-hex}}'
let s:gui17        = 'd2fc91{{^base17-hex}}9871fe{{/base17-hex}}'
...
let s:cterm12  = '{{#base12-hex}}09{{/base12-hex}}{{^base12-hex}}01{{/base12-hex}}'
let s:cterm13  = '{{#base13-hex}}11{{/base13-hex}}{{^base13-hex}}03{{/base13-hex}}'
let s:cterm14  = '{{#base14-hex}}10{{/base14-hex}}{{^base14-hex}}02{{/base14-hex}}'
let s:cterm15  = '{{#base15-hex}}14{{/base15-hex}}{{^base15-hex}}06{{/base15-hex}}'
let s:cterm16  = '{{#base16-hex}}12{{/base16-hex}}{{^base16-hex}}04{{/base16-hex}}'
let s:cterm17  = '{{#base17-hex}}13{{/base17-hex}}{{^base17-hex}}05{{/base17-hex}}'
...
let s:colors = [
  ...
  \ '#dbd6cc',
  \ '#5a5d62',
  \ '#dfb683{{^base12-hex}}e7349c{{/base12-hex}}',
  \ '#91cbcd{{^base14-hex}}04b372{{/base14-hex}}',
  \ '#61b186{{^base13-hex}}f2a633{{/base13-hex}}',
  \ '#8f72e3{{^base16-hex}}458ae2{{/base16-hex}}',
  \ '#d2fc91{{^base17-hex}}9871fe{{/base17-hex}}',
  \ '#5e84b6{{^base15-hex}}1ad0d6{{/base15-hex}}',
  \ '#f8f6f2'
\]
...
" Theme setup
let g:colors_name = 'base24-human-plus-plus'
